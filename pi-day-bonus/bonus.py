...
x = np.array([8, 8, 8, 8, 8, 9, 10, 10, 10, 10, 10, 10, 14, 14, 14, 14, 15, 16, 16,
              16, 16, 16, 4, 5, 5, 6, 8, 10, 12, 14, 16, 18, 20, 6, 8, 10, 12, 14, 16, 18, 20])

y = np.array([92, 94, 96, 98, 100, 110, 110, 112, 114, 116, 118, 120, 152, 154, 156, 158, 161, 170, 172,
              174, 176, 178, 59, 68, 70, 82, 104, 125, 144, 162, 180, 199, 220, 80, 102, 123, 142, 160, 178, 197, 218])

PLOTNAME = 'pi-day-bonus'
...
fig.savefig(PLOTNAME + '.png', dpi=250,
